    ...
    >
      ...
      <nav
        className={`container mx-auto px-4 py-4 ${
          isOpen ? 'fixed top-0 left-0 w-full h-screen' : ''
        } md:flex md:items-center md:justify-between md:static md:h-auto md:bg-transparent`}
      >
        <div className='flex items-center justify-between w-full'>
          ...
          <div className='hidden md:flex items-center space-x-8'>
            ...
            <a
              ...
              download
              className='bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 w-fit-content'
            >
              Download CV
            </a>
          </div>
        ...
        <div
          className={`fixed inset-0 w-screen h-screen transition-transform duration-300 ${
            isOpen
